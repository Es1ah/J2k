    ...
    <div className="bg-j2k-white text-j2k-black">
      ...
      <section className="relative h-[70vh] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 text-j2k-white p-4">
          ...
          />
          <p ref={introTextRef} className="text-2xl md:text-4xl font-sans mb-8 animate-fade-in-up delay-200 drop-shadow-md"> {/* Increased text size */}
      ...
      <section ref={whoWeAreRef} className="container mx-auto py-16 px-4 text-center">
