...
const EmailCapturePopup = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="bg-j2k-black text-j2k-white border-j2k-white border-2 p-6 max-w-md rounded-none"> {/* Removed rounded-lg */}
        ...
        <div className="grid gap-4 py-4">
          <Input
            ...
            className="col-span-3 bg-j2k-white text-j2k-black border-j2k-red focus:ring-j2k-red rounded-none" // Removed rounded-md
            value={email}
        ...
        <DialogFooter className="flex justify-center">
          <Button
            type="submit"
            className="bg-j2k-red hover:bg-j2k-red/80 text-j2k-white text-lg px-8 py-2 shadow-lg rounded-none" // Removed rounded-full
