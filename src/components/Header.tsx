    ...
    <header className="sticky top-0 z-50 bg-j2k-black text-j2k-white p-4 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <Link to="/about" className="text-lg font-sans hover:text-j2k-red transition-colors">About Us</Link> {/* New About Us link */}
        ...
        <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
          ...
          <SheetContent side="right" className="bg-j2k-black text-j2k-white border-j2k-white border-l-2 flex flex-col">
            ...
            <nav className="flex flex-col space-y-4 mt-8 text-center">
              ...
              <Link to="/about" className="text-lg font-sans hover:text-j2k-red transition-colors" onClick={() => setIsMobileMenuOpen(false)}>About Us</Link> {/* New About Us link */}
